...
class WebCrawler:
    ...
    def login(self):
        ...
        try:
            ...
            # driver.find_element(By.XPATH, "//button[contains(text(), 'Login')]").send_keys(Keys.RETURN)
            # login_button.click()
    ...
    def find_all_anchor_tags(self, soup, url):
    ...
    def visit_url(self, url):
        try:
            ...
            if response.status_code == 200:
                ...
                # soup = BeautifulSoup(response.text, "lxml")   # tried different parser

                # self.find_all_anchor_tags(soup, url)
...
def mock(args, domain_url, login_url, username, password):
    args.get_sitemap = True
    args.login = True
...
def main():
    ...
    args = mock(args, domain_url='https://allstate-sandbox.galaxyhealthadmin.com/management/client/dashboard',
         login_url='https://allstate-sandbox.galaxyhealthadmin.com/management/allstate/login',
         username='kendodemo@yopmail.com', password='Test@1234')

    # args = mock(args, domain_url='https://qaits.qualibar.com', login_url='https://qaits.qualibar.com/login',
    #             username='test@yopmail.com', password='test')

    # args = mock(args, domain_url='https://sandbox.vasquezplatform.com/management/ark', login_url='https://sandbox.vasquezplatform.com/management/ark/login',
    #             username='test@yopmail.com', password='test')
...
python3 ./qualibar_crawler.py --get-sitemap --domain-url https://allstate-sandbox.galaxyhealthadmin.com -login --login-url https://allstate-sandbox.galaxyhealthadmin.com/management/allstate/login -u test@yopmail.com -p test --generate-java --output-directory QaitsQualibar
